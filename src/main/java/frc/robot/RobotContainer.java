...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("FlywheelsTrenchForever", new SetFlywheelSpeed_Com(m_shooter, () -> 2250).withTimeout(20.5));
    ...
    private void configureBindings() {
        ...
        operatorController.leftStick().onTrue(new SetFlywheelSpeed_Com(m_shooter, () -> 5200.0)); //down on dpad - for passing
