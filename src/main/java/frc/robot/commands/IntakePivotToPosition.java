...
public class IntakePivotToPosition extends Command {
  ...
  private IntakePivotSub m_intakePivotSub; 
  public double m_position; 

  public IntakePivotToPosition(IntakePivotSub intakePivotSub, double position) {
    // Use addRequirements() here to declare subsystem dependencies.
    m_intakePivotSub = intakePivotSub;
    m_position = position;
    addRequirements(m_intakePivotSub);
  }

  // Called when the command is initially scheduled.
  @Override
  public void initialize() {
    m_intakePivotSub.setPositionOfIntakePivot(m_position); 
  }
